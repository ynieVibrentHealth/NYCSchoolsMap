...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let homeViewController = SchoolContainerView()
        let interacter = SchoolInteractor()
        let presenter = SchoolPresenter()
        homeViewController.output = interacter
        interacter.output = presenter
        presenter.output = homeViewController
        let router = SchoolRouter(viewController: homeViewController)
